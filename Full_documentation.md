...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/Rana5884/Anime_Recommender_system_llmops
  ls
  cd TESTING-9
...
```bash
git config --global user.email "ritvikran87gmail.com"
git config --global user.name "Rana5884"
